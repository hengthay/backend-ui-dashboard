    ...
    <div className='w-full grid md:grid-cols-3 grid-cols-1 gap-8'>
      <div className='md:col-span-2 bg-white shadow-md p-4 rounded-lg space-y-3'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-gray-900 text-base px-3 py-2 bg-gray-100 font-medium rounded-lg min-h-40'>{productDetail.descriptions}</p>
        </div>
      </div>
      <div className='bg-white shadow-md p-4 rounded-lg space-y-3'>
        ...
        <div className='space-y-2'>
          ...
          <div className='min-h-60 flex justify-center items-center text-gray-900 text-base px-3 py-2 bg-gray-100 font-medium rounded-lg border-2 border-gray-300 border-dashed'>
            <img 
            src={`http://localhost:3001/images/${productDetail.image}`} alt="Image-Product" 
      ...
      <div className='bg-white shadow-md p-4 rounded-lg space-y-3'>
        ...
        <div className='spacy-2'>
          ...
          <p className='text-gray-900 text-base px-3 py-2 bg-gray-100 font-medium rounded-lg'>Apparel & Fashion</p>
        </div>
        <div className='spacy-2'>
          <p className='text-gray-500 text-base'>Product Description</p>
          <p className='text-gray-900 text-base px-3 py-2 bg-gray-100 font-medium rounded-lg min-h-20'>Clothing, footwear, and accessories for all seasons.</p>
        </div>
      </div>
    </div>
  )
